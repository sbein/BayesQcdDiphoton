...
sms_models = {
        ...
        'T6Wg':SMS(600, 2050, 0, 2450),
        'T5Wg':SMS(600, 2420, 0, 2650),
}
# ------------------ End import by hand -----------------
        ...
        for j in range(1, hist.GetNbinsY()+1):
            ...
            if xLow >= yLow+diagonalOffset-binWidth/2.:
                if refHist!=None:                    
                    ...
                    except: print 'failing on this potentially critial line'
    return hist
...
#                  help="signal model name")
    ...
    print 'going to do this hadd:', "hadd -f "+haddout
