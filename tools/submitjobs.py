...
parser.add_argument("-directoryout", "--directoryout", type=str, default="TreeMakerRandS_skimsv1", help="This is the directory where the output will go")
parser.add_argument("-filelist", "--filelist", type=str, default="usefulthings/filelist_all.txt", help="This is the filelist to be used with the analyzer")
